...
export default function MedicalReport({ report }: MedicalReportProps) {
  ...
  return (
    <div className="h-full bg-gray-100 flex justify-center py-4 px-4">
      <div className="w-full max-w-[8.5in] min-h-full bg-white border border-gray-300 shadow-lg relative text-black text-[10px] font-sans">
        {/* Header */}
